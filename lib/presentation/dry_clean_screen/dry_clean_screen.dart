...
import '../dry_clean_screen/widgets/product1_item_widget.dart';
import 'controller/dry_clean_controller.dart';
import 'models/dry_clean_model.dart';
...
class DryCleanScreen extends StatefulWidget {
  const DryCleanScreen({Key? key}) : super(key: key);
...
class _DryCleanScreenState extends State<DryCleanScreen> {
  ...
  List<Product1ItemModel> dryCleanService = DryCleanModel.product1ItemList();
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarSubtitle(text: "lbl_dry_clean".tr),
                  ...
                  Align(
                      ...
                      child: Padding(
                          ...
                          child: ListView.separated(
                              ...
                              itemCount: dryCleanService.length,
                              itemBuilder: (context, index) {
                                Product1ItemModel model = dryCleanService[index];
                                return Product1ItemWidget(model);
                              }))),
                  Align(
