...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  Widget build(BuildContext context) {
    print("value is ===== ${widget.model.mobileNumber}");

    setState(() {
      controller.nameController.text = "Ronald richards";
      controller.addressoneController.text = widget.model.addressline1!;
      controller.addressController.text = widget.model.addressline2!;
      controller.phoneNumberController.text = widget.model.mobileNumber!;
    });
    return WillPopScope(
        onWillPop: () async {
          Get.back();
