import 'package:laundry_app/core/app_export.dart';import 'package:laundry_app/presentation/edit_address_screen/models/edit_address_model.dart';import 'package:country_pickers/country.dart';import 'package:country_pickers/utils/utils.dart';import 'package:flutter/material.dart';/// A controller class for the EditAddressScreen.
///
...
onSelected2(dynamic value) { for (var element in editAddressModelObj.value.dropdownItemList2.value) {element.isSelected = false; if (element.id == value.id) {element.isSelected = true;}} editAddressModelObj.value.dropdownItemList2.refresh(); } 
 }
