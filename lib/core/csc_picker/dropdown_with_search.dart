          ...
          decoration: !disabled
              ...
              borderRadius: BorderRadius.circular(
                getHorizontalSize(8)
                      ...
                      border:
                          Border.all(color: ColorConstant.black900,
                            width: 1,)),
          child: Row(
            children: [
              Expanded(
                  child: Text(selected.toString(),
                      ...
                      style: selectedItemStyle != null
                          ? selectedItemStyle
                          : AppStyle.txtBody)),
              // getSvgImageWithSize(context, "arrow-down.svg", 16.h, 16.h,
              //     color: getFontColor(context))
CustomImageView(svgPath: ImageConstant.imgdropDownIcon,)
              // Icon(Icons.keyboard_arrow_down_rounded,size: ,)
            ],
          ),
        ),
      ),
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                margin: EdgeInsets.symmetric(horizontal: 16),
                // child: getDefaultTextFiled(context, "", textController,
